...
From the spaghetti plot, we can see that experiment group has higher average value of observations and tend to have a higher rate of increaing over time.
