...
* For large mu, the effect size and test power will be large as well. The null hypothesis will be rejected at a probability that almost equals 1. Thus the whole dataset will be accounted into the estimation and eventually get unbiased estimation.